                                ...
                                return (
                                    <TableRow key={member.id} className={!isActive ? "bg-slate-50 dark:bg-slate-800/50 opacity-75" : ""}>
                                        <TableCell className="font-medium">
                                            ...
                                            {!isActive && <span className="ml-2 text-xs italic text-slate-500 dark:text-slate-400">(Ex-membro)</span>}
                                        </TableCell>
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button variant="ghost" size="sm" className="h-8 gap-2 text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white border border-transparent hover:border-slate-200 dark:hover:border-slate-600">
