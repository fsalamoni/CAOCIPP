...
export default function EntityTypeBuilder({ open, onOpenChange, organizationId, members = [], entityType, initialFields, onSaved }) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="w-[min(96vw,72rem)] max-w-none min-h-[24rem] h-[min(92vh,56rem)] max-h-[92vh] resize overflow-auto flex flex-col">
                <DialogHeader>
                ...
                <Tabs value={builderTab} onValueChange={setBuilderTab} className="flex-1 flex flex-col min-h-0">
                    ...
                    <ScrollArea className="flex-1 mt-3 pr-3 min-h-0 overflow-y-auto">
                        {/* IDENTIFICAÇÃO */}
