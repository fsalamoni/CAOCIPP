...
export const PARCERIA_FIELD_ALIASES = {
    ...
    renewal_notice_period: ['renewal_notice_period', 'RENEWAL_NOTICE_PERIOD'],
    renewal_notice_period_unit: ['renewal_notice_period_unit', 'RENEWAL_NOTICE_PERIOD_UNIT'],
    renewal_notice_date: ['renewal_notice_date', 'data_aviso_renovacao', 'DATA DO AVISO DE RENOVAÇÃO', 'Data do Aviso de Renovação'],
    review_notice_period: ['review_notice_period'],
    review_notice_period_unit: ['review_notice_period_unit'],
    review_notice_date: ['review_notice_date'],
