# 🚀 Quick Start Guide - CAOCIPP Local Testing
...
4. Cole ANTES das regras do CAOCIPP (que começam com `// ========== CAOCIPP PLATFORM RULES`)
...
Se você usa as mesmas coleções em outras plataformas, **renomeie as coleções do CAOCIPP**:

1. Abra `src/config/firebase.js`
2. No final do arquivo, adicione:

```javascript
// Collection names with namespace for CAOCIPP
