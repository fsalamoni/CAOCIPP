...
function calculateStatus(process) {
    ...
    if (process.review_return_date)
        return "Para revisão"; // Logic form original: review_return means "returned for review/correction" -> "Para revisão"? Or "Para assinatura"? Original said: if (process.review_return_date) return "Para revisão";
