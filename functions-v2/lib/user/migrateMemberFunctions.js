...
exports.migrateMemberFunctions = void 0;
 ...
 */
exports.migrateMemberFunctions = (0, https_1.onCall)({ region: 'southamerica-east1', cors: true }, async (request) => {
    var _a, _b;
    if (!request.auth) {
    ...
    if (((_a = request.auth.token) === null || _a === void 0 ? void 0 : _a.platform_admin) !== true) {
        throw new https_1.HttpsError('permission-denied', 'Apenas platform admin pode rodar migrações.');
    }
    ...
    while (true) {
        ...
        for (const doc of snap.docs) {
            ...
            if (currentFunction && !GENERIC_FUNCTIONS.has(currentFunction))
                continue;
            ...
            if (!profileFunction)
                continue;
            // Já está igual? Pula.
            if (profileFunction === currentFunction)
                continue;
            if (!dryRun) {
...
//# sourceMappingURL=migrateMemberFunctions.js.map